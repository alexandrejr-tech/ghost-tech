    ...
    <section className="hero section" id="home" ref={sectionRef}>
      <div className="hero__container container">
        <div className="hero__content">
          <span className="hero__subtitle animate-on-scroll" data-animation="fade-down">Olá, eu sou</span>
          <h1 className="hero__title animate-on-scroll" data-animation="fade-up">
          ...
          <p className="hero__description animate-on-scroll" data-animation="fade-up" data-delay="400">
            ...
            Desenvolvimento web e automação inteligente.
          </p>
          <div className="hero__buttons animate-on-scroll" data-animation="fade-up" data-delay="600">
          ...
          <div className="hero__social animate-on-scroll" data-animation="fade-up" data-delay="800">
        ...
        <div className="hero__image animate-on-scroll" data-animation="fade-left">
          <div className="hero__image-wrapper">
            <div className="hero__image-bg"></div>
            <img src="/assets/images/img-hero.jpeg" alt="Foto profissional de Alexandre Junior" className="hero__img" />
          </div>
        </div>
      </div>

      <a href="#about" className="scroll-indicator" aria-label="Rolar para baixo" onClick={(e) => scrollTo(e, 'about')}>
        <div className="mouse">
